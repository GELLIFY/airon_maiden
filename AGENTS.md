...
Issues live in GitHub Issues (`GELLIFY/airon_maiden`). See `docs/agents/issue-tracker.md`.
...
Single-context repo — `CONTEXT.md` + `docs/adr/` alla root. See `docs/agents/domain.md`.
